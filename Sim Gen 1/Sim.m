function [lapTime, totalEnergy_J] = Sim(gearRatios, isDebug) 
    if nargin < 2
        isDebug = false; % Default to silent for the optimizer!
    end
    if nargin < 1
    ...
    debugMode = isDebug; % Tie your plot toggle to the function input
%% 1. Basic Cleanup/Init
% Debug
