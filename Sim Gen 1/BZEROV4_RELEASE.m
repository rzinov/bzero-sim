...
function [lapTime, totalEnergy_J, topSpeed_kmh, Telemetry] = BZEROV4_RELEASE(gearRatios, isDirectDrive, sprockets, isDebug) 
    if nargin < 4
...
% Official data stimates 200,000pa pressure for MotoStudent tyres. Contact area increase of 20% up to 55 degrees
...
% ==============================================================================================
        ...
        telemetry_table = table(distance_plot(:), time_export(:), v_actual(:), v_limit(:), ...
                            steerAngle_deg(:), accel_input(:), brake_input(:), lean_deg(:), ...
                            'VariableNames', {'Distance_m', 'Time_s', 'Velocity_ms', 'VLIM_ms', ...
                                              'SteerAngle_deg', 'Throttle_0to1', 'Brake_0to1', 'Lean_deg'});
